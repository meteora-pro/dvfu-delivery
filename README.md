...
* Создайте базу postgres
И укажите к ней доступ в файле `config/api/.development`
* установите зависимости
`npm i`
* Далее запустите бэкенд
`npm run start:api`
* Для паралельного запуска с фронтендом достаточно указать
`npm start`
